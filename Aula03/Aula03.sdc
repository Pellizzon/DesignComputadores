...
#create_clock -name "key(2)" -period 80.000ns -waveform {0.0 10.0} [get_ports {key[2]}]
create_clock -name "fpga_reset_n" -period 80.000ns -waveform {0.0 10.0} [get_ports {fpga_reset_n}]
...
#set_clock_groups -exclusive -group {CLOCK_50} -group {key(2)}
set_clock_groups -exclusive -group {CLOCK_50} -group {fpga_reset_n}
